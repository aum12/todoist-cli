...
func newTasksCompletedByDueDateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "completed-by-due-date",
		Short:       "Retrieves a list of completed items strictly limited by the specified due date range (up to 6 weeks).",
		Example:     "  todoist-aum tasks completed-by-due-date --since 2026-01-15T09:00:00Z --until 2026-01-15T09:00:00Z",
		Annotations: map[string]string{"pp:endpoint": "tasks.completed-by-due-date", "pp:method": "GET", "pp:path": "/api/v1/tasks/completed/by_due_date", "mcp:read-only": "true"},
