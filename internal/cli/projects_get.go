...
func newProjectsGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get",
		Aliases:     []string{"list"},
		Short:       "Get all active user projects, optionally filtered by folder or workspace. This is a paginated endpoint.",
		Example:     "  todoist-aum projects get",
		Annotations: map[string]string{"pp:endpoint": "projects.get", "pp:method": "GET", "pp:path": "/api/v1/projects", "mcp:read-only": "true"},
	...
	cmd.Flags().StringVar(&flagFolderId, "folder-id", "", "Folder id")
