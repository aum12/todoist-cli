...
func newProjectsSearchCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "search",
		Short:       "Search active user projects by name. This is a paginated endpoint.",
		Example:     "  todoist-aum projects search --query example-value",
		Annotations: map[string]string{"pp:endpoint": "projects.search", "pp:method": "GET", "pp:path": "/api/v1/projects/search", "mcp:read-only": "true"},
