...
func newTasksGetByFilterCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-by-filter",
		Short:       "Get all tasks matching the filter. This is a paginated endpoint.",
		Example:     "  todoist-aum tasks get-by-filter --query example-value",
		Annotations: map[string]string{"pp:endpoint": "tasks.get-by-filter", "pp:method": "GET", "pp:path": "/api/v1/tasks/filter", "mcp:read-only": "true"},
