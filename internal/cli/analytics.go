...
Data must be synced first with the sync command.`,
  ...
  todoist-aum analytics --type messages

  # Group by a field
  todoist-aum analytics --type messages --group-by author_id

  # Top 10 most frequent values
  todoist-aum analytics --type messages --group-by channel_id --limit 10 --json`,
