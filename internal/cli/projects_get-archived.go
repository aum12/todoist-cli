...
func newProjectsGetArchivedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-archived",
		Short:       "Get the user's archived projects.",
		Example:     "  todoist-aum projects get-archived",
		Annotations: map[string]string{"pp:endpoint": "projects.get-archived", "pp:method": "GET", "pp:path": "/api/v1/projects/archived", "mcp:read-only": "true"},
