...
// VerifyEnvVar is the env var the test verifier sets in every
...
// DogfoodEnvVar is the env var the live integration runner
...
// test verifier in mock mode. Generated commands with side
...
// the live integration matrix. Long-running commands (full
